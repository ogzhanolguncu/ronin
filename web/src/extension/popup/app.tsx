...
export function App() {
    ...
    try {
      const [colRes, tagRes, tab] = await Promise.all([
        ...
        typeof chrome !== "undefined" && chrome.tabs
          ...
          : Promise.resolve({ url: "https://example.com", title: "Example Page" }),
      ])
  ...
  if (view === "loading") {
    content = (
      <div className="flex items-center justify-center w-[360px] min-h-[200px]">
    ...
    content = <LoginView onLogin={handleLogin} onChangeServer={() => setView("setup")} />
  } else {
    content = (
      <BookmarkForm
