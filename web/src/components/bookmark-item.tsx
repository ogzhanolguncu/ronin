...
export function BookmarkItem({ bookmark: b, onEdit, onDelete, onArchive, onTagClick }: Props) {
      ...
      <div className={s.bmActions}>
        <Tooltip.Root openDelay={400} closeDelay={0}>
          <Tooltip.Trigger asChild>
            <button className={s.bmTextAction} onClick={() => onEdit(b)}>Edit</button>
          </Tooltip.Trigger>
          <Tooltip.Positioner>
        ...
        <Tooltip.Root openDelay={400} closeDelay={0}>
          <Tooltip.Trigger asChild>
            <button className={s.bmTextAction} onClick={() => onArchive(b.id, !b.archived)}>
